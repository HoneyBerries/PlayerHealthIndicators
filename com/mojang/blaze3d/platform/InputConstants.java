...
public class InputConstants {
	...
	public static enum Type {
		...
		MOUSE(
			"key.mouse", (value, name) -> Language.getInstance().has(name) ? Component.translatable(name) : Component.translatable("key.mouse", new Object[]{value + 1})
		);
		...
		public InputConstants.Key getOrCreate(final int value) {
			return this.map.computeIfAbsent(value, (Int2ObjectFunction<? extends InputConstants.Key>)(intValue -> {
