...
public class GlTextureView extends GpuTextureView {
	...
	public int getFbo(final DirectStateAccess dsa, @Nullable final GpuTexture depth) {
		...
		if (this.firstFboDepthId == depthId) {
			...
			return this.fboCache.computeIfAbsent(depthId, (Int2IntFunction)(_depthId -> this.createFbo(dsa, _depthId)));
		}
	}
