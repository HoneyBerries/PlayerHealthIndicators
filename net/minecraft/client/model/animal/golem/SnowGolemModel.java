...
public class SnowGolemModel extends EntityModel<LivingEntityRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		root.addOrReplaceChild(
			"upper_body", CubeListBuilder.create().texOffs(0, 16).addBox(-5.0F, -10.0F, -5.0F, 10.0F, 10.0F, 10.0F, deformation), PartPose.offset(0.0F, 13.0F, 0.0F)
		);
		root.addOrReplaceChild(
			"lower_body", CubeListBuilder.create().texOffs(0, 36).addBox(-6.0F, -12.0F, -6.0F, 12.0F, 12.0F, 12.0F, deformation), PartPose.offset(0.0F, 24.0F, 0.0F)
		);
