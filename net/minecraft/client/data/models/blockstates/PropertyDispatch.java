...
public abstract class PropertyDispatch<V> {
	...
	public static class C1<V, T1 extends Comparable<T1>> extends PropertyDispatch<V> {
		...
		public PropertyDispatch<V> generate(final Function<T1, V> generator) {
			this.property1.getPossibleValues().forEach(value1 -> this.select((T1)value1, (V)generator.apply(value1)));
			return this;
		}
	}
	...
	public static class C2<V, T1 extends Comparable<T1>, T2 extends Comparable<T2>> extends PropertyDispatch<V> {
		...
		public PropertyDispatch<V> generate(final BiFunction<T1, T2, V> generator) {
			this.property1
				.getPossibleValues()
				.forEach(value1 -> this.property2.getPossibleValues().forEach(value2 -> this.select((T1)value1, (T2)value2, (V)generator.apply(value1, value2))));
			return this;
		}
	}
							...
							value2 -> this.property3
								...
								.forEach(
									value3 -> this.property4
										.getPossibleValues()
										.forEach(value4 -> this.select((T1)value1, (T2)value2, (T3)value3, (T4)value4, generator.apply((T1)value1, (T2)value2, (T3)value3, (T4)value4)))
								)
						)
				);
			return this;
	...
	public static class C5<V, T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>>
		...
		public PropertyDispatch.C5<V, T1, T2, T3, T4, T5> select(
			...
			PropertyValueList key = PropertyValueList.of(
				this.property1.value(value1), this.property2.value(value2), this.property3.value(value3), this.property4.value(value4), this.property5.value(value5)
			);
			this.putValue(key, variants);
			return this;
		}
									...
									value3 -> this.property4
										...
										.forEach(
											value4 -> this.property5
												...
												.forEach(
													value5 -> this.select(
														(T1)value1, (T2)value2, (T3)value3, (T4)value4, (T5)value5, generator.apply((T1)value1, (T2)value2, (T3)value3, (T4)value4, (T5)value5)
													)
												)
										)
								)
