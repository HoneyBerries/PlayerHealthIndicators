...
public class AtlasProvider implements DataProvider {
	...
	private static final Map<String, Identifier> TRIM_PALETTE_VALUES = (Map<String, Identifier>)extractAllMaterialAssets()
		.collect(Collectors.toMap(AssetInfo::suffix, asset -> Identifier.withDefaultNamespace("trims/color_palettes/" + asset.suffix())));
	...
	public AtlasProvider(final PackOutput output) {
		this.pathProvider = output.createPathProvider(Target.RESOURCE_PACK, "atlases");
	}
