...
public class ChatListener {
	...
	public void handlePlayerChatMessage(final PlayerChatMessage message, final GameProfile sender, final Bound boundChatType) {
	...
	public void handleChatMessageError(final UUID senderId, @Nullable final MessageSignature invalidSignature, final Bound boundChatType) {
	...
	public void handleDisguisedChatMessage(final Component message, final Bound boundChatType) {
		Instant received = Instant.now();
		this.handleMessage(null, () -> {
			LocalPlayer receiver = this.minecraft.player;
			if (receiver != null && receiver.chatAbilities().canReceivePlayerMessages()) {
	...
	private void narrateChatMessage(final Bound boundChatType, final Component content) {
