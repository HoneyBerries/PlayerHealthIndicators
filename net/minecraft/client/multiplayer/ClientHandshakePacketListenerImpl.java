...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener, PacketContextProvider {
	...
	public void fillListenerSpecificCrashDetails(final CrashReport report, final CrashReportCategory connectionDetails) {
		...
		connectionDetails.setDetail("Login phase", () -> ((ClientHandshakePacketListenerImpl.State)this.state.get()).toString());
