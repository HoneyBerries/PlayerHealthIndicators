...
public class FoxRenderer extends AgeableMobRenderer<Fox, FoxRenderState, FoxModel> {
	...
	private static final EnumMap<Variant, FoxRenderer.FoxTexturesByState> TEXTURES_BY_VARIANT = Maps.newEnumMap(
		Map.of(
			Variant.RED,
	...
	public Identifier getTextureLocation(final FoxRenderState state) {
		FoxRenderer.FoxTexturesByState byState = (FoxRenderer.FoxTexturesByState)TEXTURES_BY_VARIANT.get(state.variant);
		if (byState == null) {
