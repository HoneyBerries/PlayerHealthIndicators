...
public class ParrotOnShoulderLayer extends RenderLayer<AvatarRenderState, PlayerModel> {
	...
	public void submit(
		...
		Variant parrotOnLeftShoulder = state.parrotOnLeftShoulder;
		...
		Variant parrotOnRightShoulder = state.parrotOnRightShoulder;
	...
	private void submitOnShoulder(
		...
		submitNodeCollector.submitModel(
			this.model, parrotState, poseStack, ParrotRenderer.getVariantTexture(parrotVariant), lightCoords, OverlayTexture.NO_OVERLAY, playerState.outlineColor, null
		);
		poseStack.popPose();
	}
}
