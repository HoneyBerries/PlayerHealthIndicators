...
public abstract class AbstractSignRenderer<S extends SignRenderState> implements BlockEntityRenderer<SignBlockEntity, S> {
	...
	private void submitSignWithText(
		final S state, final PoseStack poseStack, @Nullable final ModelFeatureRenderer.CrumblingOverlay breakProgress, final SubmitNodeCollector submitNodeCollector
	) {
