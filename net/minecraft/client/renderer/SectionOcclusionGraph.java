			...
			for (Direction direction : DIRECTIONS) {
				...
				if (renderSectionAt != null && (!smartCull || !node.hasDirection(direction.getOpposite()))) {
					...
					if (smartCull && distantFromCamera) {
						...
						boolean maxX = direction.getAxis() == Axis.X ? cameraSectionCenter.getX() > renderSectionOriginX : cameraSectionCenter.getX() < renderSectionOriginX;
						boolean maxY = direction.getAxis() == Axis.Y ? cameraSectionCenter.getY() > renderSectionOriginY : cameraSectionCenter.getY() < renderSectionOriginY;
						boolean maxZ = direction.getAxis() == Axis.Z ? cameraSectionCenter.getZ() > renderSectionOriginZ : cameraSectionCenter.getZ() < renderSectionOriginZ;
