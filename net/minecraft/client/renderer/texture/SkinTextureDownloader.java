...
public class SkinTextureDownloader {
	...
	public CompletableFuture<Texture> downloadAndRegisterSkin(final Identifier textureId, final Path localCopy, final String url, final boolean processLegacySkin) {
		DownloadedTexture texture = new DownloadedTexture(textureId, url);
	...
	private CompletableFuture<Texture> registerTextureInManager(final Texture textureId, final NativeImage contents) {
		return CompletableFuture.supplyAsync(() -> {
