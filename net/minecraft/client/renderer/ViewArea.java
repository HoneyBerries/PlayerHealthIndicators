...
public class ViewArea {
	...
	protected SectionRenderDispatcher.RenderSection getRenderSectionAt(final BlockPos pos) {
	...
	private SectionRenderDispatcher.RenderSection getRenderSection(final int sectionX, final int sectionY, final int sectionZ) {
