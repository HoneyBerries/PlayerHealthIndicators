...
public class CopperGolemStatueSpecialRenderer implements NoDataSpecialModelRenderer {
	...
	public record Unbaked(Identifier texture, Pose pose) implements NoDataSpecialModelRenderer.Unbaked {
		...
		public Unbaked(final WeatherState state, final Pose pose) {
		...
		private static ModelLayerLocation getModel(final Pose pose) {
			return switch (pose) {
