...
public class FlameFeatureRenderer {
	...
	private void renderFlame(
		final PoseStack.Pose pose, final MultiBufferSource bufferSource, final EntityRenderState state, final Quaternionf rotation, final AtlasManager atlasManager
	) {
