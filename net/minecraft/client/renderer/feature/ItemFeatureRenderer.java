...
public class ItemFeatureRenderer {
	...
	private static VertexConsumer getFoilBuffer(final MultiBufferSource bufferSource, final RenderType renderType, @Nullable final PoseStack.Pose foilDecalPose) {
