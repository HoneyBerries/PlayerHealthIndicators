...
public class CycleButton<T> extends AbstractButton implements ResettableOptionWidget {
	...
	public void updateWidgetNarration(final NarrationElementOutput output) {
		...
		if (this.active) {
			...
			if (this.isFocused()) {
				output.add(NarratedElementType.USAGE, Component.translatable("narration.cycle_button.usage.focused", new Object[]{nextValueText}));
			} else {
				output.add(NarratedElementType.USAGE, Component.translatable("narration.cycle_button.usage.hovered", new Object[]{nextValueText}));
			}
		}
	}
