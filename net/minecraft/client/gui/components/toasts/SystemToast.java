...
public class SystemToast implements Toast {
	...
	private static ImmutableList<FormattedCharSequence> nullToEmpty(@Nullable final Component message) {
	...
	public void extractRenderState(final GuiGraphicsExtractor graphics, final Font font, final long fullyVisibleForMs) {
		...
		if (this.messageLines.isEmpty()) {
			...
			for (int i = 0; i < this.messageLines.size(); i++) {
				graphics.text(font, (FormattedCharSequence)this.messageLines.get(i), 18, 18 + i * 12, -1, false);
			}
		}
	}
	...
	public static void onFileDropFailure(final Minecraft minecraft, final int count) {
		add(
			...
			Component.translatable("gui.fileDropFailure.detail", new Object[]{count})
		);
	}
	...
	public static void onChunkLoadFailure(final Minecraft minecraft, final ChunkPos pos) {
		addOrUpdate(
			...
			Component.translatable("chunk.toast.loadFailure", new Object[]{Component.translationArg(pos)}).withStyle(ChatFormatting.RED),
	...
	public static void onChunkSaveFailure(final Minecraft minecraft, final ChunkPos pos) {
		addOrUpdate(
			...
			Component.translatable("chunk.toast.saveFailure", new Object[]{Component.translationArg(pos)}).withStyle(ChatFormatting.RED),
			Component.translatable("chunk.toast.checkLog")
		);
	}
