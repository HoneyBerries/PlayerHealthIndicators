...
public interface PresetEditor {
	Map<Optional<ResourceKey<WorldPreset>>, PresetEditor> EDITORS = Map.of(
		...
		(PresetEditor)(parent, settings) -> new CreateBuffetWorldScreen(
			parent, settings, biome -> parent.getUiState().updateDimensions(fixedBiomeConfigurator(biome))
		)
	);
