	...
	public final class WorldListEntry extends WorldSelectionList.Entry implements SelectableEntry {
		...
		public Component getNarration() {
			...
			if (this.summary.isLocked()) {
				entryNarration = CommonComponents.joinForNarration(new Component[]{entryNarration, WorldSelectionList.WORLD_LOCKED_TOOLTIP});
			}

			if (this.summary.isExperimental()) {
				entryNarration = CommonComponents.joinForNarration(new Component[]{entryNarration, WorldSelectionList.WORLD_EXPERIMENTAL});
			}

			return Component.translatable("narrator.select", new Object[]{entryNarration});
		}
		...
		public void doDeleteWorld() {
			...
			try {
				LevelStorageAccess access = levelSource.createAccess(levelId);
		...
		public void recreateWorld() {
			...
			try {
				LevelStorageAccess access = this.minecraft.getLevelSource().validateAndCreateAccess(this.summary.getLevelId());
