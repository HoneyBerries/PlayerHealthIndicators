	...
	protected void init() {
		...
		for (int tier = 0; tier <= 2; tier++) {
			...
			for (int c = 0; c < count; c++) {
				Holder<MobEffect> effect = (Holder<MobEffect>)((List)BeaconBlockEntity.BEACON_EFFECTS.get(tier)).get(c);
		...
		for (int c = 0; c < count - 1; c++) {
			Holder<MobEffect> effect = (Holder<MobEffect>)((List)BeaconBlockEntity.BEACON_EFFECTS.get(3)).get(c);
			BeaconScreen.BeaconPowerButton beaconPowerButton = new BeaconScreen.BeaconPowerButton(
		...
		Holder<MobEffect> dummyEffect = (Holder<MobEffect>)((List)BeaconBlockEntity.BEACON_EFFECTS.get(0)).get(0);
