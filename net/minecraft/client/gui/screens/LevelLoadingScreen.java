...
public class LevelLoadingScreen extends Screen {
	...
	private static final Object2IntMap<ChunkStatus> COLORS = (Object2IntMap<ChunkStatus>)Util.make(new Object2IntOpenHashMap(), map -> {
	...
	protected void updateNarratedWidget(final NarrationElementOutput output) {
		if (this.loadTracker.hasProgress()) {
			output.add(NarratedElementType.TITLE, Component.translatable("loading.progress", new Object[]{Mth.floor(this.loadTracker.serverProgress() * 100.0F)}));
		}
	}
