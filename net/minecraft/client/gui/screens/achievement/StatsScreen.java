		...
		private class MobRow extends ObjectSelectionList.Entry<StatsScreen.MobsStatisticsList.MobRow> {
			...
			public MobRow(final EntityType<?> type) {
				...
				if (kills == 0) {
					...
					this.kills = Component.translatable("stat_type.minecraft.killed", new Object[]{kills, this.mobName});
					this.hasKills = true;
				}
				...
				if (killedBy == 0) {
					...
					this.killedBy = Component.translatable("stat_type.minecraft.killed_by", new Object[]{this.mobName, killedBy});
