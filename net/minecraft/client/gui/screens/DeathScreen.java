...
public class DeathScreen extends Screen {
	...
	public DeathScreen(@Nullable final Component causeOfDeath, final boolean hardcore, final LocalPlayer player) {
		...
		this.deathScore = Component.translatable("deathScreen.score.value", new Object[]{scoreValue});
	}
	...
	public boolean mouseClicked(final MouseButtonEvent event, final boolean doubleClick) {
		...
		return clickedStyle != null && clickedStyle.getClickEvent() instanceof OpenUrl openUrl
