...
public class TelemetryEventWidget extends AbstractTextAreaWidget {
	...
	public void setOnScrolledListener(@Nullable final DoubleConsumer listener) {
	...
	private void addEventType(final TelemetryEventWidget.ContentBuilder builder, final TelemetryEventType eventType, final boolean isDisabled) {
		...
		builder.addHeader(this.font, this.grayOutIfDisabled(Component.translatable(titleTranslationPattern, new Object[]{eventType.title()}), isDisabled));
	...
	private static class ContentBuilder {
		...
		public void addHeader(final Font font, final Component line) {
			this.layout
				.addChild(new MultiLineTextWidget(line, font).setMaxWidth(this.width - 64).setCentered(true), s -> s.alignHorizontallyCenter().paddingHorizontal(32));
			this.narration.append(line).append("\n");
		}
