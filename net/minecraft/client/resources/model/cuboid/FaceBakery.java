...
public class FaceBakery {
	...
	public static BakedQuad bakeQuad(
		...
		for (int i = 0; i < 4; i++) {
			bakeVertex(
				i, faceInfo, uvs, uvRotation, uvTransform, from, to, materialInfo, modelState.transformation(), elementRotation, vertexPositions, vertexPackedUvs, interner
			);
		}
		...
		return new BakedQuad(
			...
			vertexPackedUvs[2],
			vertexPackedUvs[3],
			(Direction)Objects.requireNonNullElse(finalDirection, Direction.UP),
			materialInfo
		);
	}
