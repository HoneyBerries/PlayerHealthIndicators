...
public class AtlasManager implements AutoCloseable, PreparableReloadListener, SpriteGetter {
	...
	public void prepareSharedState(final SharedState currentReload) {
	...
	public CompletableFuture<Void> reload(
		...
		AtlasManager.PendingStitchResults pendingStitches = (AtlasManager.PendingStitchResults)currentReload.get(PENDING_STITCH);
