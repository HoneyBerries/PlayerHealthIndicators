...
public class BabyAxolotlAnimation {
	public static final AnimationDefinition BABY_AXOLOTL_IDLE_FLOOR = AnimationDefinition.Builder.withLength(2.88F)
		...
		.addAnimation(
			"right_front_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(160.0F, -10.0F, -37.5F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"right_front_leg",
		...
		.addAnimation(
			"right_hind_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(1.72F, KeyframeAnimations.degreeVec(360.0F, 0.0F, -45.0F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"left_front_leg",
	...
	public static final AnimationDefinition IDLE_FLOOR_UNDERWATER = AnimationDefinition.Builder.withLength(5.12F)
		...
		.addAnimation(
			"right_front_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(5.04F, KeyframeAnimations.degreeVec(190.0F, -15.0F, -30.0F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"right_front_leg",
		...
		.addAnimation(
			"right_hind_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(360.0F, 0.0F, -30.0F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"right_hind_leg",
		...
		.addAnimation(
			"left_front_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(5.04F, KeyframeAnimations.degreeVec(190.0F, 18.0F, 30.0F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"left_front_leg",
		...
		.addAnimation(
			"left_hind_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(5.04F, KeyframeAnimations.degreeVec(180.0F, 0.0F, 30.0F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"left_hind_leg",
	...
	public static final AnimationDefinition IDLE_UNDERWATER = AnimationDefinition.Builder.withLength(5.2F)
		...
		.addAnimation(
			"right_front_leg",
			new AnimationChannel(
				AnimationChannel.Targets.POSITION, new Keyframe(0.0F, KeyframeAnimations.posVec(0.15F, -0.3391F, 0.0876F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"right_hind_leg",
	...
	public static final AnimationDefinition BABY_AXOLOTL_PLAY_DEAD = AnimationDefinition.Builder.withLength(0.04F)
		...
		.addAnimation(
			"body",
			new AnimationChannel(AnimationChannel.Targets.SCALE, new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.0, 1.0, 1.0), AnimationChannel.Interpolations.LINEAR))
		)
		.addAnimation(
			"right_front_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(202.35F, -30.33F, -40.82F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"right_front_leg",
		...
		.addAnimation(
			"right_hind_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(418.0F, -50.0F, 35.8F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"right_hind_leg",
		...
		.addAnimation(
			"left_front_leg",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(177.0F, 22.76F, 15.9F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"left_front_leg",
		...
		.addAnimation(
			"right_gills",
			new AnimationChannel(
				AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, -55.87F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
			)
		)
		.addAnimation(
			"right_gills",
